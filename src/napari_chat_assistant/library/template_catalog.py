...
PROMPT_TEMPLATE_RECORDS: list[dict[str, Any]] = [
    ...
    {
        "id": "prompt_what_can_you_do_with_current_layers",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "What Can You Do With Current Layers?",
        "category": "Getting Started",
        "description": "Ask the assistant to inspect the current viewer state and suggest the most useful built-in next actions.",
        "best_for": "Users who are unsure how to phrase a task and want the plugin to orient them from the existing layers.",
    ...
    },
    {
        ...
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Isolate Selected Layer",
        "category": "Quick Controls",
        "description": "Hide every other layer so only the selected layer stays visible.",
        "best_for": "Reducing viewer clutter before inspection, threshold preview, or focused measurement on one layer.",
        "suggested_followup": "Ask to show all layers again after inspection or to proceed with analysis on the isolated layer.",
        "tags": ["prompt", "layers", "visibility", "selected-layer", "isolate"],
        "prompt": "Hide all layers except the selected layer.",
    },
    {
        "id": "prompt_show_all_layers",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Show All Layers Again",
        "category": "Quick Controls",
        "description": "Turn all currently loaded layers back on after an isolation or hide workflow.",
        "best_for": "Restoring the full viewer state after focused inspection of one layer.",
        "suggested_followup": "Ask for grid view or a comparison plan once the full layer set is visible again.",
        "tags": ["prompt", "layers", "visibility", "show-all", "viewer"],
        "prompt": "Show all layers again.",
    },
    {
        "id": "prompt_hide_all_layers",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Hide All Layers",
        "category": "Quick Controls",
        "description": "Turn every layer off in the current viewer.",
        "best_for": "Quickly clearing the canvas before selectively re-enabling or isolating a target layer.",
        "suggested_followup": "Ask to turn on only a named layer or the selected layer after clearing the viewer.",
        "tags": ["prompt", "layers", "visibility", "hide-all", "viewer"],
        "prompt": "Hide all layers.",
    },
    {
        "id": "prompt_compare_layers_in_grid_view",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Grid View Toggle",
        "category": "Quick Controls",
        "description": "Turn napari grid view on or off for side-by-side image comparison.",
        "best_for": "Switching between tiled comparison view and the normal overlapping viewer with one editable prompt.",
        "suggested_followup": "Load this prompt and replace `on` with `off` when you want to return to overlap view.",
        "tags": ["prompt", "grid-view", "compare", "viewer", "layout"],
        "prompt": "Turn grid view on for all open image layers.",
    },
    {
        "id": "prompt_fit_view",
        "branch": "plugin_prompt",
        ...
        "best_for": "Recovering a clean overall view after zooming or panning.",
        "suggested_followup": "Ask to zoom in on the selected layer or isolate one layer if you want a more focused view.",
        "tags": ["prompt", "view", "camera", "fit"],
        "prompt": "Fit the current visible layers in view.",
    },
    {
        "id": "prompt_zoom_in",
        "branch": "plugin_prompt",
        ...
        "title": "Zoom In",
        "category": "Quick Controls",
        "description": "Zoom the viewer camera in.",
        "best_for": "Moving closer to the current area without using mouse-wheel gestures.",
        "suggested_followup": "Ask to fit view again if you zoom too far.",
        "tags": ["prompt", "view", "camera", "zoom-in"],
        "prompt": "Zoom in.",
    },
    {
        "id": "prompt_zoom_out",
        ...
        "title": "Zoom Out",
        "category": "Quick Controls",
        "description": "Zoom the viewer camera out.",
        "best_for": "Seeing more of the current scene without using mouse-wheel gestures.",
        "suggested_followup": "Ask to fit view if you want the whole scene centered again.",
        "tags": ["prompt", "view", "camera", "zoom-out"],
        "prompt": "Zoom out.",
    },
    {
        "id": "prompt_toggle_2d_3d",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Toggle 2D And 3D",
        "category": "Quick Controls",
        "description": "Switch the viewer between 2D and 3D camera modes.",
        "best_for": "Jumping between slice-based and 3D viewing with one prompt.",
        "suggested_followup": "Ask to fit view after switching if the camera framing looks off.",
        "tags": ["prompt", "view", "camera", "2d", "3d"],
        "prompt": "Toggle the viewer between 2D and 3D.",
    },
    {
        "id": "prompt_tooltips_toggle",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Tooltips Toggle",
        "category": "Quick Controls",
        "description": "Turn layer tooltips on or off.",
        "best_for": "Toggling hover hints without navigating the view menu.",
        "suggested_followup": "Load this prompt and replace `on` with `off` when you want less hover clutter.",
        "tags": ["prompt", "tooltips", "viewer", "overlay"],
        "prompt": "Turn layer tooltips on.",
    },
    {
        "id": "prompt_axes_toggle",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Axes Toggle",
        "category": "Quick Controls",
        "description": "Turn the viewer axes on or off.",
        "best_for": "Switching the main axes overlay without opening the view menu.",
        "suggested_followup": "Load this prompt and replace `on` with `off` when you want to hide the axes again.",
        "tags": ["prompt", "axes", "viewer", "overlay"],
        "prompt": "Turn the viewer axes on.",
    },
    {
        "id": "prompt_axes_labels_toggle",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Axes Labels Toggle",
        "category": "Quick Controls",
        "description": "Turn axes labels on or off.",
        "best_for": "Switching axis-name text without opening the view menu.",
        "suggested_followup": "Load this prompt and replace `on` with `off` when you want to hide the labels.",
        "tags": ["prompt", "axes", "labels", "viewer"],
        "prompt": "Turn axes labels on.",
    },
    {
        "id": "prompt_axes_colored_toggle",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Axes Colored Toggle",
        "category": "Quick Controls",
        "description": "Turn colored axes styling on or off.",
        "best_for": "Switching color-coded axes without opening the view menu.",
        "suggested_followup": "Load this prompt and replace `on` with `off` when you want plain axes styling.",
        "tags": ["prompt", "axes", "colored", "viewer"],
        "prompt": "Turn colored axes on.",
    },
    {
        "id": "prompt_axes_dashed_toggle",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Axes Dashed Toggle",
        "category": "Quick Controls",
        "description": "Turn dashed axes styling on or off.",
        "best_for": "Switching between dashed and solid axes styling without opening the view menu.",
        "suggested_followup": "Load this prompt and replace `on` with `off` when you want solid axes again.",
        "tags": ["prompt", "axes", "dashed", "viewer"],
        "prompt": "Turn dashed axes on.",
    },
    {
        "id": "prompt_axes_arrows_toggle",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Axes Arrows Toggle",
        "category": "Quick Controls",
        "description": "Turn axes arrowheads on or off.",
        "best_for": "Switching axis direction arrows without opening the view menu.",
        "suggested_followup": "Load this prompt and replace `on` with `off` when you want a cleaner axes overlay.",
        "tags": ["prompt", "axes", "arrows", "viewer"],
        "prompt": "Turn axes arrows on.",
    },
    {
        "id": "prompt_scale_bar_toggle",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Scale Bar Toggle",
        "category": "Quick Controls",
        "description": "Turn the scale bar on or off.",
        "best_for": "Switching the main scale reference overlay without opening the view menu.",
        "suggested_followup": "Load this prompt and replace `on` with `off` when you want to hide the scale bar.",
        "tags": ["prompt", "scale-bar", "viewer", "overlay"],
        "prompt": "Turn the scale bar on.",
    },
    {
        "id": "prompt_scale_bar_box_toggle",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Scale Bar Box Toggle",
        "category": "Quick Controls",
        "description": "Turn the scale bar box on or off.",
        "best_for": "Switching the contrast box behind the scale bar without opening the view menu.",
        "suggested_followup": "Load this prompt and replace `on` with `off` when you want a cleaner scale bar style.",
        "tags": ["prompt", "scale-bar", "box", "viewer"],
        "prompt": "Turn the scale bar box on.",
    },
    {
        "id": "prompt_scale_bar_colored_toggle",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Scale Bar Colored Toggle",
        "category": "Quick Controls",
        "description": "Turn colored scale bar styling on or off.",
        "best_for": "Switching colored scale bar styling without opening the view menu.",
        "suggested_followup": "Load this prompt and replace `on` with `off` when you want plain scale bar styling.",
        "tags": ["prompt", "scale-bar", "colored", "viewer"],
        "prompt": "Turn colored scale bar on.",
    },
    {
        "id": "prompt_scale_bar_ticks_toggle",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Scale Bar Ticks Toggle",
        "category": "Quick Controls",
        "description": "Turn scale bar ticks on or off.",
        "best_for": "Switching scale bar tick marks without opening the view menu.",
        "suggested_followup": "Load this prompt and replace `on` with `off` when you want a simpler scale bar again.",
        "tags": ["prompt", "scale-bar", "ticks", "viewer"],
        "prompt": "Turn scale bar ticks on.",
    },
    {
        "id": "prompt_bounding_box_toggle",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Bounding Box Toggle",
        "category": "Quick Controls",
        "description": "Turn the selected layer bounding box on or off.",
        "best_for": "Switching the selected-layer extent overlay without opening layer controls.",
        "suggested_followup": "Load this prompt and replace `on` with `off` when you want to hide the box again.",
        "tags": ["prompt", "selected-layer", "bounding-box", "viewer"],
        "prompt": "Turn the selected layer bounding box on.",
    },
    {
        "id": "prompt_layer_name_toggle",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Layer Name Toggle",
        "category": "Quick Controls",
        "description": "Turn the selected layer name overlay on or off.",
        "best_for": "Switching the selected-layer name overlay without opening layer controls.",
        "suggested_followup": "Load this prompt and replace `on` with `off` when you want to hide the in-view name again.",
        "tags": ["prompt", "selected-layer", "name-overlay", "viewer"],
        "prompt": "Turn the selected layer name overlay on.",
    },
    {
        "id": "prompt_named_layer_visibility",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Named Layer Visibility",
        "category": "Quick Controls",
        "description": "Show or hide one named layer without changing the others.",
        "best_for": "Switching one known layer on or off from natural language instead of clicking the layer list.",
        "suggested_followup": "Load this prompt and swap `show` for `hide` when you want the opposite visibility state.",
        "tags": ["prompt", "layers", "visibility", "named-layer"],
        "prompt": "Show layer: image_a.",
    },
    {
        "id": "prompt_show_only_named_layer",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Show Only Named Layer",
        "category": "Quick Controls",
        "description": "Keep one named layer visible and hide everything else.",
        "best_for": "Isolating one known layer quickly without manual visibility clicks.",
        "suggested_followup": "Ask to show all layers again after inspection.",
        "tags": ["prompt", "layers", "visibility", "named-layer", "isolate"],
        "prompt": "Show only layer: image_a.",
    },
    {
        "id": "prompt_show_only_image_layers",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Show Only Image Layers",
        "category": "Quick Controls",
        "description": "Keep only image layers visible and hide all labels, shapes, and points.",
        "best_for": "Cleaning the viewer down to raw or processed images only.",
        "suggested_followup": "Ask to show labels layers again if you want annotations back.",
        "tags": ["prompt", "layers", "visibility", "image-layers"],
        "prompt": "Show only image layers.",
    },
    {
        "id": "prompt_prepare_image_review_workflow",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Prepare Image Review Workflow",
        "category": "Quick Controls",
        "description": "Run several safe viewer controls in order: hide annotation layers, keep images visible, adjust overlays, tile images, and fit the camera.",
        "best_for": "Demonstrating why prompt-based controls are useful when one natural-language instruction replaces many clicks or hotkeys.",
        "suggested_followup": "Say `undo last workflow` if you want to restore the viewer controls from before this workflow.",
        "tags": ["prompt", "workflow", "automation", "quick-controls", "image-review"],
        "prompt": "Prepare this viewer for image review: hide labels and points layers, show only image layers, turn axes labels on, hide the scale bar, tile the images in grid view, and fit the view.",
    },
    {
        "id": "prompt_undo_last_workflow",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Undo Last Workflow",
        "category": "Quick Controls",
        "description": "Restore the viewer-control state captured before the last safe quick-control workflow.",
        "best_for": "Backing out of a prompt-driven viewer setup without manually reversing every visibility, overlay, grid, or camera change.",
        "suggested_followup": "Run another quick-control workflow after confirming the viewer returned to the expected state.",
        "tags": ["prompt", "workflow", "undo", "restore", "quick-controls"],
        "prompt": "Undo last workflow.",
    },
    {
        "id": "prompt_labels_layers_visibility",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Labels Layers Visibility",
        "category": "Quick Controls",
        "description": "Show or hide all labels layers without changing other layer visibility.",
        "best_for": "Toggling segmentation overlays as a group without manually clicking each labels layer.",
        "suggested_followup": "Load this prompt and swap `hide` for `show` when you want the opposite labels-layer state.",
        "tags": ["prompt", "layers", "visibility", "labels-layers"],
        "prompt": "Hide labels layers.",
    },
    {
        "id": "prompt_delete_roi_layers",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Delete ROI Layers",
        "category": "Quick Controls",
        "description": "Delete all Shapes ROI layers from the viewer.",
        "best_for": "Cleaning temporary ROI outlines and selection shapes quickly.",
        "suggested_followup": "Ask to save the workspace first next time if the ROI layers matter.",
        "tags": ["prompt", "layers", "delete", "roi", "shapes"],
        "prompt": "Delete all ROI shape layers.",
    },
    {
        "id": "prompt_delete_point_layers",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Delete Point Layers",
        "category": "Quick Controls",
        "description": "Delete all points layers from the viewer.",
        "best_for": "Cleaning temporary prompt points or annotation points quickly.",
        "suggested_followup": "Ask to save the workspace first next time if the point annotations matter.",
        "tags": ["prompt", "layers", "delete", "points"],
        "prompt": "Delete all point layers.",
    },
    {
        "id": "prompt_set_selected_scale_0_1",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Set Selected Scale To 0.1",
        "category": "Quick Controls",
        "description": "Set the selected layer scale to 0.1 on every axis.",
        "best_for": "Applying a known uniform scale quickly without opening layer properties.",
        "suggested_followup": "Ask to reset the selected layer scale to 1 if you want to undo it.",
        "tags": ["prompt", "layers", "scale", "selected-layer"],
        "prompt": "Set the selected layer scale to 0.1 on every axis.",
    },
    {
        "id": "prompt_reset_selected_scale",
        "branch": "plugin_prompt",
        "template_type": "prompt",
        "title": "Reset Selected Scale",
        "category": "Quick Controls",
        "description": "Reset the selected layer scale to 1 on every axis.",
        "best_for": "Undoing a temporary scale change quickly without opening layer properties.",
        "suggested_followup": "Ask to set a different scale value if you want a calibrated pixel size instead.",
        "tags": ["prompt", "layers", "scale", "selected-layer", "reset"],
        "prompt": "Reset the selected layer scale to 1 on every axis.",
    },
    {
