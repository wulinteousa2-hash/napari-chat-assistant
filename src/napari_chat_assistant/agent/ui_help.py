...
UI_HELP_ITEMS = [
    ...
    },
    {
        ...
        "aliases": ("current context", "context"),
        "purpose": "Shows the assistant's compact view of the current napari session and selection.",
        "when": "Use it when you want to confirm which layers and selection state the assistant is seeing.",
        "tip": "If the assistant seems out of sync, click Refresh Context.",
    },
    {
        "label": "Refresh Context",
        "aliases": ("refresh context",),
        "purpose": "Refreshes the assistant's current view of layers, selection, and compact context text.",
        "when": "Use it when you changed layers or selection and want the context panel updated right away.",
        "tip": "It refreshes context only. It does not send a chat request.",
    },
    {
        "label": "Advanced",
...
def build_ui_help_prompt_block() -> str:
    lines = [
        ...
        "- Current Context: compact summary of what the assistant sees in the viewer.",
        "- Refresh Context: refreshes the current context panel without sending a chat request.",
